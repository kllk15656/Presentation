...
When you want to reuse elements across multiple pages of your wireframes, it's helpful to create a component. This means you can add instances of this component throughout your design files, and they will automatically inherit its properties.
...
To make your components responsive to different screen sizes, enable ‘Auto Layout’ by pressing Shift + A or by clicking ‘Auto Layout’ (make sure all your components are selected). This will group all icons into a single parent container.

![Layers Tab](../Presentation/tutorial-images/tutorial-img9.jpg)

### Step 4

Then you can set the layout properties for the component's frame. By setting the Gap to Auto, the spacing will automatically adjust whenever the size of the frame changes. In this example, the following properties have been set:
...
![Sizing](../Presentation/tutorial-images/tutorial-img12.jpg)
![Components](../Presentation/tutorial-images/tutorial-img13.jpg)
...
![Instance](../Presentation/tutorial-images/tutorial-img14.jpg)

Then, drag the corner to fit your desired frame size, it will now automatically adjust the sizing properties to match those set in the main component. 

![Instance](../Presentation/tutorial-images/tutorial-img15.jpg)
...
![Instance](../Presentation/tutorial-images/tutorial-img16.jpg)

### Part 3: Creating variants
...
![Instance](../Presentation/tutorial-images/tutorial-img17.jpg)

![Instance](../Presentation/tutorial-images/tutorial-img18.jpg)

## Step 2

With the shape selected, click Ctrl+Alt+K or right click and select ‘Create component’.

![CreateComponent](../Presentation/tutorial-images/tutorial-img19.jpg)

## Step 3

With the component selected, click the + button within the properties panel and select ‘Variant’.

![CreateVariant](../Presentation/tutorial-images/tutorial-img20.jpg)

## Step 4

This will set the original shape as the first variant. To add another, click on the purple + button.

![AddVariant](../Presentation/tutorial-images/tutorial-img21.jpg)
...
![UncheckedBox](../Presentation/tutorial-images/tutorial-img22.jpg)

Ensure you rename each varient so its easier to reference later in your designs.

![UncheckedBox](../Presentation/tutorial-images/tutorial-img23.jpg)
...
![UncheckedBox](../Presentation/tutorial-images/tutorial-img24.jpg)
![UncheckedBox](../Presentation/tutorial-images/tutorial-img25.jpg)
